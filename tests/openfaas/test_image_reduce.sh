...
# output img.log
# "app3" "app6" "app13" "tinydb"  "marshal" "graph" "game"  "auth"  "formatter"  "crypto" "psutil" "cli-application"  "type-check" 
FUNCTIONS=("app9" "cat-dot" "nlp-ner" "audio" "opencv-img" "pdfminer" "app5" "app10" "geopandas")
